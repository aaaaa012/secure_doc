...
- **[Business Requirements (BRD)](./business_requirements.md)**: High-level business needs and scope.
- **[Functional Requirements (FRD)](./functional_requirements.md)**: Detailed functional specifications, including **API Endpoints** and **Authentication Mechanisms**.
- **[Non-Functional Requirements (NFR)](./nonfunctional_requirements.md)**: Security, performance, and reliability standards.
